...
if($mode["mode"]=="edit")
{
    $arrData=$objMySQL->QuerySingleRowArray('SELECT * FROM '.TBL_PROGRAMME.' WHERE id='.$mode["id"].' ',MYSQL_ASSOC);
} else{
    $arrData=FALSE;
}
if ($arrData!==FALSE) {
    ...
    if ($mode["mode"]=="create") {  
        ...
        $objTemplate->display("prog_create");
    }
    else{
