...
<div id="frame_devicenav">
    ...
    <th style="width:22%;text-align:center;vertical-align:middle;" class="{$system_sort_order}"><a href="index.php?sort_name=system&sort_order={$sort_order}">System-Typ</a>{$system_IMG}</th>
