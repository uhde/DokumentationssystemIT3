...
<tr >
    ...
    <td>
        <input type="submit"  value="Kopie des Gerätes Speichern" onclick="javascript: form.action='auswertung_kunden_geraete.php?name=geraete&mode=create&kunde={$kunde}&kategorie={$kategorie}&kopieren=1';" />
    </td>
</tr>
</form>
...
<tr >
    <td align="center" colspan="2">
     ...
     <td>
        <input type="submit"  class="button1" value="Speichern und Neues Programm hinzufügen" onclick="javascript: form.action='auswertung_kunden_geraete.php?kopieren=0&name=geraete&mode=create&kunde={$kunde}&kategorie={$kategorie}&prog_add=5';" />
    </td>
</tr>
</form>
